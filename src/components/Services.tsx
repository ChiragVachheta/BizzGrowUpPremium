...
const SERVICES = [
  { icon: Code2, title: 'Custom Web Application & Portal Development', desc: 'We build custom web apps, interactive client dashboards, SaaS prototypes, and automated business web tools tailored to your exact business workflow. We develop responsive, full-stack applications with dynamic dashboards and custom API integrations tailored to your workflow.' },
  ...
  { icon: ShoppingCart, title: 'E-Commerce Ready', desc: 'Turn visitors into paying customers with a full online store. We set up product catalogs with categories, shopping carts, secure checkout, and payment gateway integration. Manage orders easily from a simple dashboard, with or without technical knowledge. Built with scalable database architectures and secure payment gateway integrations to handle high transaction volumes.' },
